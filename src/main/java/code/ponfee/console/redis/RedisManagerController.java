...
public class RedisManagerController {
    ...
    private static final List<Thead> THEADS = Arrays.asList(
        new Thead("key",    1, 0, new Tmeta(Type.CHAR, null, Align.LEFT, true, null)), 
        new Thead("type",   2, 0, new Tmeta(Type.CHAR, null, Align.CENTER, true, null)), 
        new Thead("expire", 3, 0, new Tmeta(Type.CHAR, null, Align.CENTER, true, null)) 
    );
