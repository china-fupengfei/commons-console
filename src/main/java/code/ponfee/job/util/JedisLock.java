 ...
 * class X {
 *   public void m() {
 *     Lock lock = new JedisLock(redis, "lockKey", 5);
...
public class JedisLock implements Lock, java.io.Serializable {
    ...
    private static final String KEY_PREFIX = "jedis:lock:";
    ...
    public JedisLock(RedisTemplate<String, byte[]> redis, String lockKey) {
        this(redis, lockKey, MAX_TOMEOUT_SECONDS);
    }

    public JedisLock(RedisTemplate<String, byte[]> redis, 
